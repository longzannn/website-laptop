        ...
        <div class="home-content">
            <div class="sales-boxes">
                <div class="recent-sales box">
                    ...
                    <form class="product-information" enctype="multipart/form-data" method="POST" action="">
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="prd_name" id="prd_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="mb-6">
                            ...
                            <input class="text-gray-500" name="images" type="file" id="imageUpload" accept="image/*" />
                            <div id="imagePreview">
                                <img class="mt-3" id="previewImage" src="" alt="" />
                            </div>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="number" name="old_price" id="old_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
