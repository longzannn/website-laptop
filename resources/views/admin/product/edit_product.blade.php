                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <select name="version_status" id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                    <option value="Còn hàng" @if($product -> version_status == 'Còn hàng') selected @endif>Còn hàng</option>
                                    <option value="Hết hàng" @if($product -> version_status == 'Hết hàng') selected @endif>Hết hàng</option>
                                </select>
