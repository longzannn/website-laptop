                ...
                <div class="recent-sales box">
                    ...
                    <form class="account-information" method="POST" action="{{ route('staff.update', $id) }}">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="staff_name" id="staff_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $staff -> staff_name }}" />
                            ...
                            @if($errors->has('staff_name'))
                                <span class="text-red-600 text-xs">{{ $errors->first('staff_name') }}</span>
                            @endif
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="email" id="email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $staff -> email }}" />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="staff_phone" id="staff_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $staff -> staff_phone }}" />
                            ...
                            @if($errors->has('staff_phone'))
                                <span class="text-red-600 text-xs">{{ $errors->first('staff_phone') }}</span>
                            @endif
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="staff_address" id="staff_address" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $staff -> staff_address }}" />
                            ...
                            @if($errors->has('staff_address'))
                                <span class="text-red-600 text-xs">{{ $errors->first('staff_address') }}</span>
                            @endif
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="password" name="password" id="password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $staff -> password }}" />
