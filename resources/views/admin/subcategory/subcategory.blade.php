...
<head>
    ...
    <link rel="stylesheet" href="../../../public/css/admin/subcategory.css">
</head>
...
<body>
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 mb-8">
                            <ul class="flex justify-center flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                                <li class="mr-2 tab-item">
                                    <span class="inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active group">
                                        Laptop
                                    </span>
                                </li>
                                <li class="mr-2 tab-item">
                                    <span class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 group">
                                        Phụ Kiện
                                    </span>
                                </li>
                            </ul>
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4">Phụ Kiện</td>
                                            <td class="px-6 py-4">
                                                <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                                <a href class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                                    Delete
    ...
    <script src="../../../public/js/admin/handleUITabs.js"></script>
