                ...
                <div class="recent-sales box">
                    ...
                    <div class="tab-pane block">
                        <div class="sales-details">
                            ...
                            <button type="button"
                                class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-8 mb-2"><a
                                    href="{{ route('subcategory.create') }}">Add a new subcategory</a></button>
                        </div>
